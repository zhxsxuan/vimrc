...
" neosnippet{
    ...
    "The following fixes a bug of neosnippet
...
set history=1000                " Number of histories stored (default is 20)
...
"set conceallevel=2 concealcursor=i
let g:tex_conceal="agm"         " Conceal feature for LaTeX
